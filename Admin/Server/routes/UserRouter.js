...
import { changePassword, createUser, deleteUserByEmail, findAllUsers, findUserById, FindUserscounts, forgotPassword, login, updateUserById } from "../controller/UserController.js";
...
userRouter.get("/Usercount",FindUserscounts)
