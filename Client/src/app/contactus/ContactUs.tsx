...
const ContactUs = () => {
  ...
  return (
    <><Head>
     <title>- ContactUs</title> </Head><div className="px-4 w-full py-16 lg:py-24 md:pb-32 md:container">
      <ToastContainer
        className="text-2xl"
        position="top-right"
        autoClose={3000}
            ...
            <ul className="footer footer-list">
              ...
              <li className="footer-item">
                ...
                <address className="contact-link address">
                 Sankeshwar  (Belgaum), Karnataka, 431001
                </address>
              </li>
              <li className="footer-item">
